...
query_id = 5910984
table_name = "Polymarket_Weekly_Notional_Volume_by_Category"
...
SELECT DATE_TRUNC('week', block_time) as "Week", custom_tag, SUM(shares)/2 as "Notional Volume" FROM polymarket_polygon.market_trades p
