...
query_id = 5745388
table_name = "Weekly_Prediction_Market_Transactions"
...
SELECT
DATE_TRUNC('week', block_time) as "week", tx_hash as "Transaction"
FROM base.logs b 
...
SELECT "week", COUNT(DISTINCT "Transaction") as "Transactions" FROM (
SELECT DATE_TRUNC('week', evt_block_time) as "week",
evt_tx_hash as "Transaction"
...
kalshi as (
SELECT DATE_TRUNC('week', CAST(date as DATE)) as "Week", SUM(value) as "Trades" FROM dune.datadashboardsapi.dataset_kalshi_daily_metrics
